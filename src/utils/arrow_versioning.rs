...
use arrow::datatypes::Schema as Schemav57;
...
use arrow_schema::Schema as Schemav56;
...
pub fn convert_record_batch_56_to_57(batch_v56: &RecordBatchv56) -> Result<RecordBatchv57> {
...
pub fn convert_record_batch_57_to_56(batch_v57: &RecordBatchv57) -> Result<RecordBatchv56> {
    let mut buffer = Vec::new();
    {
...
pub fn convert_schema_56_to_57(schema_v56: Arc<Schemav56>) -> Result<Arc<Schemav57>> {
    let empty_batch = RecordBatchv56::new_empty(schema_v56);
    let batch_v57 = convert_record_batch_56_to_57(&empty_batch)?;
    Ok(batch_v57.schema())
}

pub fn convert_schema_57_to_56(schema_v57: Arc<Schemav57>) -> Result<Arc<Schemav56>> {
    let empty_batch = RecordBatchv57::new_empty(schema_v57);
    let batch_v56 = convert_record_batch_57_to_56(&empty_batch)?;
    Ok(batch_v56.schema())
}
