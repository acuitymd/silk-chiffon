...
class TestArrowToParquet:
    ...
    def test_basic_conversion(self, tmp_path):
        ...
        daisy.arrow_to_parquet(str(arrow_file), str(parquet_file))
    ...
    def test_with_compression(self, tmp_path):
        ...
        for comp in compressions:
            ...
            daisy.arrow_to_parquet(str(arrow_file), str(parquet_file), compression=comp)
            assert parquet_file.exists()
    ...
    def test_statistics_options(self, tmp_path):
        ...
        for stats in stats_options:
            ...
            daisy.arrow_to_parquet(str(arrow_file), str(parquet_file), statistics=stats)
            assert parquet_file.exists()
...
class TestArrowToDuckDB:
    ...
    def test_basic_conversion(self, tmp_path):
        ...
        create_test_arrow_file(str(arrow_file))
        daisy.arrow_to_duckdb(str(arrow_file), str(db_file), "test_table")
    ...
    def test_truncate_file(self, tmp_path):
        ...
        daisy.arrow_to_duckdb(str(arrow_file), str(db_file), "new_table", truncate=True)
    ...
    def test_append_to_existing_db(self, tmp_path):
        ...
        daisy.arrow_to_duckdb(str(arrow_file1), str(db_file), "table1")

        daisy.arrow_to_duckdb(str(arrow_file2), str(db_file), "table2")
...
class TestArrowToArrow:
    ...
    def test_file_to_stream(self, tmp_path):
        ...
        daisy.arrow_to_arrow(str(input_file), str(output_file))
    ...
    def test_stream_to_file(self, tmp_path):
        ...
        output_file = tmp_path / "test_output.arrow"
        daisy.arrow_to_arrow(str(stream_file), str(output_file))
    ...
    def test_with_compression(self, tmp_path):
        ...
        for comp in compressions:
            ...
            daisy.arrow_to_arrow(str(input_file), str(output_file), compression=comp)
            assert output_file.exists()
    ...
    def test_batch_size(self, tmp_path):
        ...
        daisy.arrow_to_arrow(str(input_file), str(output_file), record_batch_size=250)
...
class TestErrorHandling:
    ...
    def test_invalid_input_file(self):
        ...
        with pytest.raises(Exception):
            daisy.arrow_to_parquet("/non/existent/file.arrow", "output.parquet")
